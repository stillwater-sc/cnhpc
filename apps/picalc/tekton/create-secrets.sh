...
# Docker Hub CR
kubectl create secret generic my-registry-secret --type="kubernetes.io/basic-auth" --from-literal=username=stillwater --from-literal=password=$DOCKER_HUB_TOKEN
